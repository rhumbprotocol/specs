...
```json
{
  ...
  "description": "Breaking changes from v0.29.0: phases.duration_minutes renamed to duration_minutes",
  "version": "2.0.0",
  "type": "object",
  "properties": {
    "schema_version": {
...
|---|---|---|---|
| 0.29.0 | 1.x.x | ✓ Yes | Patch updates always compatible |
| 0.29.0 | 2.0.0 | ⚠ Maybe | Breaking changes possible |
...
| **Version embedding** | Track schema version | `schema_version: "0.29.0"` |
