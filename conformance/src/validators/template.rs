...
const TEMPLATES: &[(&str, &str)] = &[
    ...
    (
        ...
        include_str!("../../../templates/display/SUBPHASE-COMPLETE-DISPLAY.md.template"),
    ),
];
...
mod tests {
    ...
    #[test]
    fn embedded_template_count_is_twenty_four() {
    ...
    fn template_run_passes_canonical_in_place() -> TestResult {
        ...
        assert_eq!(
            result.passed, 24,
            "expected 24 templates discovered + passed under canonical tree, got {}",
            result.passed
        );
        Ok(())
    }
