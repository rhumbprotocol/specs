...
`https://rhumbprotocol.dev/schemas/v0.28.0/idea.schema.json`). As the protocol
...
1. **Version-pinned validation**: An artifact authored against v0.28.0 is always
   valid against v0.28.0, regardless of what v0.28.0 introduces.
