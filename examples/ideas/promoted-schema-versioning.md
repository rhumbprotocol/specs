...
`https://rhumbprotocol.dev/schemas/v0.25.3/idea.schema.json`). As the protocol
...
1. **Version-pinned validation**: An artifact authored against v0.25.3 is always
   valid against v0.25.3, regardless of what v0.26.0 introduces.
