...
The protocol version is stored in [`VERSION`](./VERSION). For breaking protocol-shape changes during the pre-1.0 period, bump MINOR, for example `0.29.0` to `0.31.0`. PATCH is only for backward-compatible corrections.
